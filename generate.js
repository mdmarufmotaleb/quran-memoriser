...
import { this_page_verses as get_this_page_verses } from "./filters/pages_filter.js";
...
function mesh_filters(this_chapter_verses, this_page_verses, this_hizb_verses) {
    ...
    if (get_this_page_verses() !== null) {
        meshed_filters.push(get_this_page_verses());
    }
...
function generate() {
    var all_filtered_verses = mesh_filters(this_chapter_verses, get_this_page_verses, this_hizb_verses);
